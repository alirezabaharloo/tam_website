...
const AdminPageNotFound = () => {
  ...
  return (
    <div className="fixed inset-0 bg-quinary-tint-800 flex items-center justify-center p-4 sm:p-6 md:p-8">
      <div
        className="w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl 2xl:max-w-3xl max-h-full overflow-y-auto"
        style={{
          scrollbarWidth: 'thin',
          scrollbarColor: '#980B1C #F8D5D5',
        }}
      >
        <style jsx>{`
        ...
        <motion.div initial="hidden" animate="visible" variants={containerVariants} className="w-full">
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div className="bg-primary p-4 sm:p-6 md:p-8 text-center">
              <motion.div variants={iconVariants} className="mb-4 sm:mb-6 md:mb-8">
              ...
              >
                متأسفانه صفحه‌ای که به دنبال آن هستید در پنل مدیریت وجود ندارد یا ممکن است منتقل/حذف شده باشد
              </motion.p>
            </div>
            ...
            <div className="p-4 sm:p-6 md:p-8">
                  ...
                  <div className="space-y-2 sm:space-y-3 text-right">
                    <div className="flex items-start space-x-2 sm:space-x-3 space-x-reverse">
                      ...
                      <p className="text-xs sm:text-sm text-secondary-tint-300 leading-relaxed">
                        آدرس صفحه را بررسی کنید یا دوباره تلاش کنید
                      </p>
                    </div>
                    <div className="flex items-start space-x-2 sm:space-x-3 space-x-reverse">
                      <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-quaternary rounded-full mt-1.5 sm:mt-2 flex-shrink-0"></div>
                      <p className="text-xs sm:text-sm text-secondary-tint-300 leading-relaxed">
                        از منوی پنل مدیریت برای یافتن بخش مورد نظر استفاده کنید
                      </p>
                    </div>
                    <div className="flex items-start space-x-2 sm:space-x-3 space-x-reverse">
                      <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-quaternary rounded-full mt-1.5 sm:mt-2 flex-shrink-0"></div>
                      <p className="text-xs sm:text-sm text-secondary-tint-300 leading-relaxed">
                        به داشبورد بازگردید و از آن‌جا ادامه دهید
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <motion.div variants={itemVariants} className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                ...
                >
                  ...
                  <p className="text-xs text-quinary-tint-200 leading-relaxed">بازگشت به صفحه اصلی پنل مدیریت</p>
                </button>
                ...
                >
                  <div className="flex items-center justify-center space-x-2 sm:space-x-3 space-x-reverse mb-2 sm:mb-3">
                    <FaSearch className="text-lg sm:text-xl group-hover:scale-110 transition-transform duration-200" />
                    <span className="text-sm sm:text-base font-semibold">بخش اخبار</span>
                  </div>
                  <p className="text-xs text-quinary-tint-200 leading-relaxed">مرور بخش‌های پرتردد برای ادامه کار</p>
                </button>
              </motion.div>

              {/* Additional Action */}
              <motion.div variants={buttonVariants} className="mt-4 sm:mt-6">
                <button
                  onClick={handleGoBack}
                  className="w-full group bg-quinary text-secondary rounded-lg sm:rounded-xl p-4 sm:p-6 text-center transition-all duration-300 hover:bg-quinary-tint-200 hover:scale-105 active:scale-95 border border-quinary-tint-300"
                >
                  <div className="flex items-center justify-center space-x-2 sm:space-x-3 space-x-reverse mb-2 sm:mb-3">
                    <FaArrowLeft className="text-lg sm:text-xl group-hover:scale-110 transition-transform duration-200" />
                    <span className="text-sm sm:text-base font-semibold">بازگشت به صفحه قبل</span>
                  </div>
                  <p className="text-xs text-secondary leading-relaxed">بازگشت به مسیر قبلی</p>
                </button>
              </motion.div>

              {/* Help Text */}
              <motion.div variants={itemVariants} className="mt-4 sm:mt-6 md:mt-8 text-center">
                <div className="bg-quinary-tint-50 rounded-lg sm:rounded-xl p-4 sm:p-6 border border-secondary-tint-200">
                  <p className="text-xs sm:text-sm text-secondary-tint-300 leading-relaxed">
                    اگر فکر می‌کنید این یک خطا است، با تیم پشتیبانی تماس بگیرید یا مسیر را از داشبورد دوباره انتخاب کنید
                  </p>
                </div>
              </motion.div>
            </div>

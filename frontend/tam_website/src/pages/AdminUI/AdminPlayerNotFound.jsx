        ...
        >
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div className="bg-primary p-4 sm:p-6 md:p-8 text-center">
              ...
              >
                متأسفانه بازیکن مورد نظر شما در سیستم یافت نشد یا ممکن است حذف شده باشد
              </motion.p>
            </div>
            ...
            <div className="p-4 sm:p-6 md:p-8">
                  ...
                  <div className="space-y-2 sm:space-y-3 text-right">
                    <div className="flex items-start space-x-2 sm:space-x-3 space-x-reverse">
                      ...
                      <p className="text-xs sm:text-sm text-secondary-tint-300 leading-relaxed">
                        به بخش بازیکنان بروید و بازیکن مورد نظر را جستجو کنید
                      </p>
                    </div>
                    <div className="flex items-start space-x-2 sm:space-x-3 space-x-reverse">
                      <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-quaternary rounded-full mt-1.5 sm:mt-2 flex-shrink-0"></div>
                      <p className="text-xs sm:text-sm text-secondary-tint-300 leading-relaxed">
                        بازیکن جدیدی اضافه کنید یا بازیکن مشابهی را ویرایش کنید
                      </p>
                    </div>
                    <div className="flex items-start space-x-2 sm:space-x-3 space-x-reverse">
                      <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-quaternary rounded-full mt-1.5 sm:mt-2 flex-shrink-0"></div>
              ...
              >
                ...
                >
                  <div className="flex items-center justify-center space-x-2 sm:space-x-3 space-x-reverse mb-2 sm:mb-3">
                    ...
                    <span className="text-sm sm:text-base font-semibold">بخش بازیکنان</span>
                  </div>
                  <p className="text-xs text-quinary-tint-200 leading-relaxed">
                    مشاهده و جستجو در تمام بازیکنان موجود
                  </p>
                </button>
              </motion.div>
              ...
              >
                ...
                >
                  <div className="flex items-center justify-center space-x-2 sm:space-x-3 space-x-reverse mb-2 sm:mb-3">
                    ...
                    <span className="text-sm sm:text-base font-semibold">افزودن بازیکن</span>
                  </div>
                  <p className="text-xs text-secondary leading-relaxed">
                    ایجاد بازیکن جدید در سیستم
                  </p>
                </button>
              </motion.div>
              ...
              >
                <div className="bg-quinary-tint-50 rounded-lg sm:rounded-xl p-4 sm:p-6 border border-secondary-tint-200">
                  <p className="text-xs sm:text-sm text-secondary-tint-300 leading-relaxed">
                    اگر مطمئن هستید که بازیکن باید وجود داشته باشد، با تیم پشتیبانی تماس بگیرید
                  </p>
                </div>
              </motion.div>
            </div>
...
export default AdminPlayerNotFound;

...
export default function NewsDetail() {
  ...
  const suggestedArticles = useMemo(() => {
    return newsData
      ...
      .slice(0, 3)
  }, [id]) // Only recalculate when the article ID changes
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Image */}
      <div className="w-full h-[708px] mt-4 relative">
        <img 
          src={news.image} 
          alt={news.title} 
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            ...
            >
              <svg 
                ...
                strokeWidth={0.5} 
                stroke="currentColor" 
                className="size-24 text-quinary-tint-800 transition-transform duration-300 group-hover:scale-110"
              >
      ...
      <div className="w-full">
        <div className="grid grid-cols-12 gap-4 px-4 md:px-8 lg:px-[70px]">
          ...
          <div className="col-span-12 lg:col-span-8 relative -mt-[163px] mb-32">
            <div className="w-full bg-quinary-tint-900 shadow-[0_0_16px_rgba(0,0,0,0.25)] p-8 min-h-[900px]">
              <h1 className="text-[36px] font-bold text-secondary line-clamp-2">
                {news.title}
              </h1>
              
              {/* Main content */}
              <div className="text-[24px] font-regular text-secondary mt-6 whitespace-pre-line">
                {news.content}
              </div>
              ...
              <div className="mt-[42px] flex flex-col">
                {/* Publication date */}
                <div className="text-[16px] font-normal text-secondary-tint-500">
                  {news.date}
                </div>
                ...
                <div className="flex items-center justify-between mt-6">
                  ...
                  <div className="flex items-center gap-6">
                    {news.keywords?.map((keyword, index) => (
                      <div 
                        key={index}
                        className="min-w-[119px] h-[32px] bg-secondary-tint-500 flex items-center justify-center rounded-[20px] px-4"
                      >
                        <span className="text-[16px] font-regular text-quinary-tint-800 whitespace-nowrap">
                          {keyword}
                        </span>
                      </div>
                    ))}
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-secondary font-medium">{news.dislikes}</span>
                      <button 
                    ...
                    {/* Likes */}
                    <div className="flex items-center gap-2">
                      <span className="text-secondary font-medium">{news.likes}</span>
                      <button 
                    ...
                    {/* Separator */}
                    <div className="h-[30px] w-px bg-secondary/50"></div>

                    {/* Views */}
                    <div className="flex items-center gap-2">
                      <span className="text-secondary">{news.views}</span>
          ...
          {/* Suggested Articles */}
          <div className="col-span-12 lg:col-span-4 mt-6 mb-32">

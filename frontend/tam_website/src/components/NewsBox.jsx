...
const NewsBox = ({ news }) => {
  const { title, image, type, date, category, description, id, slideshowImages } = news;
    ...
    >
      ...
      <div className="h-1/2 p-2 sm:p-3 md:p-4 flex flex-col">
        <div className="flex items-center">
          ...
          <h3 className="text-[16px] sm:text-[18px] md:text-[20px] font-bold text-secondary line-clamp-2">{getLocalizedValue(title)}</h3>
        </div>
        ...
        <div className="mt-auto flex items-center justify-between">
          <div className="flex items-center">
            <span className="text-[10px] sm:text-[11px] md:text-[12px] font-regular text-secondary-tint-200">{getLocalizedValue(date)}</span>
            <div className="h-3 w-[1px] bg-secondary mx-2"></div>
            <span className="text-[10px] sm:text-[11px] md:text-[12px] font-regular text-quaternary">{getLocalizedValue(category)}</span>
          </div>
          <div>
            <svg 

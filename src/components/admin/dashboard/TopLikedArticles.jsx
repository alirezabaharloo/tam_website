            ...
            >
              ...
              <div className="flex flex-col gap-1 px-4 py-3">
                <div className="flex items-center gap-2 mb-1">
                  <span className="bg-quaternary/10 text-quaternary text-xs font-bold px-2 py-0.5 rounded-full">
                    #{index + 1}
                  </span>
                ...
                <p className="text-secondary font-bold text-base md:text-lg group-hover:text-quaternary transition-colors duration-200">
                  {article.title}
                </p>
              </div>
            </motion.div>
...
export default TopLikedArticles;

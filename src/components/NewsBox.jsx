    ...
    >
      ...
      <div className="h-1/2 p-2 flex flex-col">
        <div className="flex items-center">
          ...
          <h3 className="text-[20px] font-bold text-secondary">{title}</h3>
        </div>
        ...
        <div className="mt-auto flex items-center">
          <span className="text-[12px] font-regular text-secondary-tint-200">{date}</span>
          <div className="h-4 w-[1px] bg-secondary mx-4"></div>
          <span className="text-[12px] font-regular text-quaternary">{category}</span>
          <svg 
